                ...
                <table border=1>
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_object()){
                            ...
                            echo '<td><a style="text-decoration:none;color:inherit" href="detail.php?id='.$row->idproduk.'">'.$row->nama_produk.'</td> ';
                            echo '<td>'.$row->last_update.'</td> ';
                            echo '<td><img src="../media/'.$row->gambar_produk.'" width=100px></td> ';
                            echo '</tr>';
                            $i++;
                        }
                        $result->free();
