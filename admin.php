    ...
    <div class="container">
        <div class="row">
            <div class="sidebar-sticky" id="menu">
                ...
                <a href="admin/admin_kategori.php">Kategori</a>
                <a href="admin/admin_subkategori.php">Sub Kategori</a>
                <a href="admin/admin_produk.php">Produk</a>
                <a href="admin/admin_pegawai.php">Pegawai</a>
                <a href="admin/operation/editPegawai.php?id=<?php echo $_SESSION['id']; ?>">Profil Saya</a>
            </div>
            <div class="col-lg-2">
            </div>
            <div class="col-lg-10" id="content">
                ...
                <div class="row info">
                    ...
                    <div class="infobox">
                        ...
                        echo '<p>Jumlah Pegawai</p>';
                        echo '<p id="jumstaf">' . $result->num_rows . '</p>';
                        ?>
                    </div>
                </div>
                <br />
