...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Okt 2019 pada 09.55
...
('001', 'arir', 'Syahrir', 'dummy1@email.com', 'password01', 'A'),
('002', 'arya', 'Aryarafi', 'dummy2@email.com', 'password02', 'B'),
('003', 'ainun', 'ainun herlambang', 'ainunherlambang@gmai', 'ainun123', 'A'),
('004', 'ipul', 'syaiful', 'dummy04@gmail.com', 'password03', 'A'),
('005', 'johan', 'johanadi', 'dummy05@gmail.com', 'password05', 'B');
...
CREATE TABLE `produk` (
  ...
  `idsubkategori` varchar(11) NOT NULL,
  `idkategori` varchar(11) NOT NULL,
...
INSERT INTO `subkategori` (`idsubkategori`, `nama_subkategori`, `detail`) VALUES
('10', 'Business', NULL),
('11', 'Gaming', NULL),
('12', '2 in 1', NULL),
('20', 'Cellphone', NULL),
('21', 'Featurephone', NULL),
('22', 'Smartphone', NULL),
('30', 'Tube', NULL),
('31', 'LCD', NULL),
('32', 'Curve 180', NULL),
...
ALTER TABLE `kategori` ADD FULLTEXT KEY `idkategori` (`idkategori`,`nama_kategori`,`detail`);
